...
def encrypt_password(password: str): # selection of hashing function
...
# creation of the password file and adding new users, part of Problem3.py (sign up)
...
# retrieving users from password file, part of Problem4.py (log in)
